!(function(t) {
  function e(t, e) {
    ...
    (this.$selector = t), (this.options = n(
      this.options,
      e
    ...
    )), this.bindEvents(), this.createCustomEvent(), this.currentItemIndex ===
      -1 &&
      (
    ...
    var o = this;
    setTimeout(function() {
      (o.event.detail.currentItemIndex =
        o.currentItemIndex), o.$selector.dispatchEvent(o.event);
    }, 0);
  }
  function s(t, e) {
  ...
  (u.updateButtonStates = function() {
    ...
    o(
      ...
      s(this.options.hidePreviousClass, this.$selector),
      this.options.hidePreviousClass
    ), o(
      s(this.options.hideNextClass, this.$selector),
      this.options.hideNextClass
    ), o(
      s(this.options.showPreviousClass, this.$selector),
      this.options.showPreviousClass
    ), o(
      s(this.options.showNextClass, this.$selector),
    ...
    if (
      ...
      (
        (t = t === -1 && this.options.carousel ? this.lastItemIndex : t),
        (t = t === this.lastItemIndex + 1 && this.options.carousel ? 0 : t),
        !(t < 0 || t > this.lastItemIndex)
      )
    ) {
